...
As in the exercises for week 6, I have stored the data that I would have expected at this point and import it here.
...
3.  Write a meaningful commit message (e.g. "Completed week 6 tidyr homework") in the **Commit message** box
4.  Click **Commit**. Note that every commit needs to have a commit message associated with it.
5.  Click **Push** to send your changes to GitHub.
6.  Go to your md-06-USERNAME GitHub repo (where USERNAME is your GitHub username) and refresh the page. You should see your commit message next to the updated files.

## Open an issue on GitHub

Once you have ensured that the Quarto document renders without errors and you have pushed all your changes to GitHub, it is to complete the assignment by opening an issue on your md-06-USERNAME GitHub repo (where USERNAME is your GitHub username).

1.  Navigate to your md-06-USERNAME GitHub repo (where USERNAME is your GitHub username).
